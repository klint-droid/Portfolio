    ...
    return(
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 h-full">
            <div className="flex items-center gap-2 mb-4">
                <FaRegBookmark className="text-gray-700" size={24} />
                <h2 className="text-lg font-bold text-gray-900">Beyond Coding</h2>
            </div>
            <div className="space-y-4 text-sm text-gray-600 leading-tight">
